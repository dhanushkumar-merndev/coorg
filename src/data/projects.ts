...
export const completedProjects: EstateProject[] = [
  {
    ...
    description: [
      "A farmland community in Coorg with agricultural parcels and internal access roads, described by the developer as a quiet setting for weekend living and long-term land ownership.",
    ],
    status: "completed",
    ...
    images: [
      sourceImage("star-woods-estate-3", "Source marketing image of small buildings beside a winding road on a misty green hillside"),
      sourceImage("star-woods-estate-2", "Source marketing image of a stone cottage with a tiled roof and planted surroundings at sunset"),
      sourceImage("star-woods-estate-1", "Source marketing image of a landscaped road lined with trees and contemporary houses"),
    ],
  ...
  },
  {
    ...
    description: [
      "Managed farmland in Madikeri, described with plantation surroundings, separate land parcels and internal paths. The developer positions the project around private farm retreats.",
    ],
    status: "completed",
    availability: "sold-out",
    availabilitySource: "user-confirmed",
    ...
    images: [
      sourceImage("star-coffee-county-3", "Source marketing image of planted hillsides, winding tracks and scattered buildings"),
      sourceImage("star-coffee-county-1", "Source marketing aerial image of green parcels divided by a road network"),
      sourceImage("star-coffee-county-2", "Source marketing image of a multistorey building with balconies and street trees"),
    ],
    sourceUrl: STAR_INFRA_SOURCE,
    price: null,
    publicReady: false,
  ...
  },
  {
    ...
    images: [
      sourceImage("star-misty-acres-1", "Source marketing image of a stone and timber villa beside a landscaped stream and misty hills"),
      sourceImage("star-misty-acres-2", "Source marketing image of a two-storey villa, lawn and stream with wooded hills behind"),
      sourceImage("star-misty-acres-3", "Source marketing image of a lit villa overlooking a pond at dusk"),
    ],
    sourceUrl: STAR_INFRA_SOURCE,
    price: null,
    publicReady: false,
...
export const ongoingProjects: EstateProject[] = [
  {
    ...
    description: [
      "An ongoing residential development in Bengaluru with 2 and 3 BHK homes. The developer describes vastu-compliant layouts without common walls, with planned leisure and landscaped spaces.",
      "The source brochure presents swimming pools, a gym, gardens, a jogging track and security among the proposed amenities. The illustrations and floor plan describe the marketing concept.",
    ],
    status: "ongoing",
    availability: null,
    areaLabel: null,
    features: [
      "2 & 3 BHK homes",
      "No common walls · source description",
      "Vastu-compliant layouts · source description",
    ...
    images: [
      {
        ...
        alt: "Arkha Sanctuary marketing brochure with an apartment-building rendering and project branding",
      ...
      },
      {
        ...
        alt: "Arkha Sanctuary conceptual brochure showing proposed amenities, apartment cutaways and a pool courtyard",
