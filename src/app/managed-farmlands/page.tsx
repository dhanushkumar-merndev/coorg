...
import { ongoingProjects, completedProjects, managedFarmlandsPreview, STAR_INFRA_SOURCE } from "@/data/projects";
...
export const metadata: Metadata = {
  ...
  description: "Discover ongoing and completed projects together, from the Coorg farmland collection to the wider Star Infra Developers portfolio.",
...
export default function ManagedFarmlandsPage() {
  return <PageMotion className={styles.page} tone="plantation">
    ...
    <section id="completed-projects" className={`${styles.section} ${projects.collectionSection}`} aria-labelledby="completed-heading">
      ...
      <div className={projects.collectionFoot}><p className={projects.sourceNote}>Project information from <a href={STAR_INFRA_SOURCE} target="_blank" rel="noreferrer">Star Infra Developers</a>. Portfolio images are illustrative marketing material.</p><a href="#ongoing-projects" className={projects.textLink}>Back to ongoing projects ↑</a></div>
    </section>
    ...
    <NextChapter href="/estates" eyebrow="EXPLORE ESTATES" title="A closer look at the land." line="Discover Coorg estate profiles, acreage and photographs from the supplied collection." />
  </PageMotion>;
}
